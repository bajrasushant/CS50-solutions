...
def onedit():
    ...
    # todo_to_delete_id = todo_to_delete[0]
    # todo_to_delete_user_id = todo_to_delete[1]
    db.execute("DELETE FROM todos WHERE id=? AND user_id=?", todo_to_delete[0][0], todo_to_delete[0][1])
